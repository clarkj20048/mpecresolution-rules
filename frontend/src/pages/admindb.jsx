...
function AdminDB() {
  ...
  const acceptResolution = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/pending-resolutions/${id}/accept`, {
        method: 'POST',
      });
  ...
  const rejectResolution = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/pending-resolutions/${id}/reject`, {
        method: 'POST',
      });
